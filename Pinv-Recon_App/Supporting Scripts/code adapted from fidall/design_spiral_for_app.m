%design_spiral_for_app
%adapting the design spiral code for the Pinv-Recon app - Sofia Pearson - 19/05/2025

function [k,dcf,t,ind,grad]=design_spiral_for_app(fov,npix,arms,ksamp,...
    gmax,smax,nucleus,acq_round2n,balanced)
%DESIGN_SPIRAL Design a spiral with delayed acq for fast CSI
%[k,dcf,t,ind,grad]=design_spiral(fov,npix,arms,ksamp,...
%    gmax,smax,nucleus,acq_round2n,balanced)
%
